...
class MorekepalabalaiView extends GetView<MorekepalabalaiController> {
  @override
        ...
        children: [
          ...
          Column(children: [
            ...
            Container(
              ...
              child: Center(
                  child: Text(
                "Aplikasi for Android v1.0.1 arm64-v8a \n2022 ",
                textAlign: TextAlign.center,
                style:
                    GoogleFonts.openSans(fontSize: 12, color: Colors.grey[200]),
              )),
            )
          ]),
        ],
